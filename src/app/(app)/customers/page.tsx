  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Link href="/crm" className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-[#0070E0] text-white text-sm font-medium hover:bg-[#005fc4] transition-colors">
          Open CRM
        </Link>
      </div>
