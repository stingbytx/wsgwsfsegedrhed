  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/executive-dashboard" className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-[#0070E0] text-white text-sm font-medium hover:bg-[#005fc4] transition-colors">
          <FileBarChart className="h-4 w-4" /> Executive BI Dashboard
        </Link>
      </div>
